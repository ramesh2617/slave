pipeline {
    ...
    stages  {	
        ...
        stage('Set Git Credentials'){
		  steps{
            git credentialsId: 'e8fe7044-14cf-4c53-b693-cc45e142c906', url: 'https://github.com/ramesh2617/master.git'
            git credentialsId: 'e8fe7044-14cf-4c53-b693-cc45e142c906', url: 'https://github.com/ramesh2617/slave.git'
          }
		}  
